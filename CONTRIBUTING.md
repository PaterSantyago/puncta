# Contribute to Puncta

[Product entry](README.md) · [User documentation](docs/README.md)
...
| `pnpm docs:check`   | Check documentation source markers, local links, and coverage entries |
...
- [Core](packages/core/README.md): synchronous text/HTML typography, optional hyphenation, SHY removal and diagnostics.
