...
| Protection and structural boundaries                                                     | Interior spaces after opaque/technical fragments versus real line indentation; new per-rule protection cases plus `protection.test.mjs`; br/wbr/hr/img/block boundaries; warnings suppressed in protected text |
