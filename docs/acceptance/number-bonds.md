...
transcribed from the contract, never generated from the recognizer.

| Requirement                                     | Evidence                                                                                                                                                                       |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Full case-sensitive base catalog and composites | Literal 44-unit input/output in both locales, whole designation negatives, unknown case, combining marks, suffixes and multiplication separators                               |
...
| Complete currency catalog                       | Three symbols in both orders and locales, three codes in both orders; original numeric notation including leading decimals; original atypical intervals and `currency.order`   |
