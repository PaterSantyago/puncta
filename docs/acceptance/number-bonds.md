...
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Full case-sensitive base catalogue and composites | Literal 44-unit input/output in both locales, whole designation negatives, unknown case, combining marks and suffixes                                              |
...
| Complete currency catalogue                       | Three symbols in both orders and locales, three codes in both orders; original numeric notation; original atypical intervals and `currency.order`                  |
...
| Interaction and invariants                        | Quotes/ellipsis/spaces literals, 12,000 seeded generated contexts over two locales and three configurations, original edits, idempotence and full-range protection |
