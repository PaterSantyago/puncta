...
| En dash, ASCII hyphen with known unit or standalone opt-in, U+2212 exclusion                                                                               | Bonds “range eligibility is atomic…” and “formatting switches…”; original sign remains independent of grouping.                                                                                                                                                                                                                                                                                                                                                                                |
...
checks and the expanded 90-test focused run passed after that fix.
