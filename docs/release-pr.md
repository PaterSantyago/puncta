...
After authorization, the enabled publication workflow publishes these exact archives to npm under `next` with provenance. A new package still needs the owner bootstrap procedure described in `docs/releases.md`.
